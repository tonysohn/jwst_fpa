...
# idl_tel_method='planar_approximation'
...
for program_id in program_ids:
    ...
    # data_dir = os.path.join('/Users/jsahlmann/jwst/tel/jwst/focal_plane_calibration/simulation/simulation/simulator_output/{}'.format(program_id))
    # data_dir = os.path.join('/Users/jsahlmann/jwst/tel/jwst/distortion_calibration/simulation/simulator_output/{}/pipeline'.format(program_id))
